...
Para el proceso de descarga y control de calidad (QC) se desarrolló un *pipeline* en Nextflow (@pipe_over) que permite realizar ambas tareas simultáneamente (`src/preprocces_data.nf`) [2](#section-1).
...
![Relación entre la proporción de lecturas multimapeadas y las lecturas no alineadas, evaluando la especificidad del alineamiento.](../results/alignments/stats/aligned_vs_time.png){#fig-multimapped-vs-unaligned fig-pos="H" width="85%" fig-align="center"}
...
![Flujo de pipeline de nextflow desarrollada para el preprocesamiento de los datos de secuenciación desde su descarga](../results/pipeline_over_nextflow.png){#pipe_over fig-pos="H" width="85%" fig-align="center"}
...
--onlyclean true \
--metadata \
/export/space3/users/ismadlsh/LCG/S4/transcriptomica/Astrocite_eOH_transcriptomic_analysis/data/in_clean_srr.csv \
--trimF 1 \
...
--onlyalign true \
--metadata \
/export/space3/users/ismadlsh/LCG/S4/transcriptomica/Astrocite_eOH_transcriptomic_analysis/data/in_align_srr.csv \
--aligner both \
--star_index \
/export/space3/users/ismadlsh/LCG/S4/transcriptomica/Astrocite_eOH_transcriptomic_analysis/data/reference/indexes/star \
--hisat_index \
/export/space3/users/ismadlsh/LCG/S4/transcriptomica/Astrocite_eOH_transcriptomic_analysis/data/reference/indexes/hisat/hisat \
--threads 8 \
--annotation_file \
